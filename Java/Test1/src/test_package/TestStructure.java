package test_package; // First Line always for packages

// imports
import java.util.*; // import all util using *
import java.util.Scanner; // import a specific util which is Scanner
